...
export function setupStationaryObstacles(){
    ...
    const b4g = new THREE.BoxGeometry(5, 1, 2);
    const b4m = new THREE.MeshBasicMaterial({ color: 0x000080, wireframe: false });
    ...
    const b8g = new THREE.BoxGeometry(2.5, 1, 2);
    ...
    const b11g = new THREE.BoxGeometry(5, 0.5, 2);
    const b11m = new THREE.MeshBasicMaterial({ color: 0x000080, wireframe: false });
    const b11 = new THREE.Mesh(b11g, b11m);

    const b12g = new THREE.BoxGeometry(3.75, 2, 2);
    const b12m = new THREE.MeshBasicMaterial({ color: 0x000080, wireframe: false });
